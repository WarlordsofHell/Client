    ...
    implements Runnable
{
    ...
    public static String findcachedir() {
		File file = new File("./WarlordsofHellCache/");
		if (!file.exists()) {
			if (!file.mkdir())
				return sencondDir();
		}
		return "./WarlordsofHellCache/";
    }
	
	public static String sencondDir() {
		File file = new File("C:/Users/Bas van Driel/Warlords of Hell/Client/Class/WarlordsofHellCache/");
		if (!file.exists())
			file.mkdir();
