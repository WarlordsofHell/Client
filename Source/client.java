...
interfaceButtonAction = 0;
	...
	public final String methodR(int j) {
		...
		public String getRank(int i){ 
                //TODO - Add Colors to Loyalty Titles
                //NOTE - Can do this much faster when having a new text engine ;(
		switch(i){
			case 1:
			return "Lord ";
			case 2:
	...
	public void drawChannelButtons() {
		...
		switch(cButtonCPos) {
			case 0: chatButtons[1].drawSprite(5, 144); break;
			case 1: chatButtons[1].drawSprite(62, 144); break;
			case 2: chatButtons[1].drawSprite(119, 144); break;
			case 3: chatButtons[1].drawSprite(176, 144); break;
			case 4: chatButtons[1].drawSprite(233, 144); break;
			case 5: chatButtons[1].drawSprite(290, 144); break;
			case 6: chatButtons[1].drawSprite(347, 144); break;
		} 
		if(cButtonHPos == cButtonCPos) {
			switch(cButtonHPos) {
				case 0: chatButtons[2].drawSprite(5, 144); break;
				case 1: chatButtons[2].drawSprite(62, 144); break;
				case 2: chatButtons[2].drawSprite(119, 144); break;
				case 3: chatButtons[2].drawSprite(176, 144); break;
				case 4: chatButtons[2].drawSprite(233, 144); break;
				case 5: chatButtons[2].drawSprite(290, 144); break;
				case 7: chatButtons[2].drawSprite(347, 144); break;
				case 6: chatButtons[3].drawSprite(404, 144); break;
			}
		} else {
			switch(cButtonHPos) {
				case 0: chatButtons[2].drawSprite(5, 144); break;
		...
		smallText.method389(true, 425, 0xffffff, "Report Abuse", 158);
		smallText.method389(true, 26, 0xffffff, "All", 158);
		smallText.method389(true, 76, 0xffffff, "Game", 158);
		...
		smallText.method382(disabledColor[publicChatMode], 147, text[publicChatMode], 165, true);
		smallText.method382(disabledColor[privateChatMode], 203, text[privateChatMode], 165, true);
		smallText.method382(disabledColor[clanChatMode], 261, text[clanChatMode], 165, true);
		smallText.method382(disabledColor[tradeMode], 318, text[tradeMode], 165, true);
		smallText.method382(65280, 374, "On", 165, true);
	}
		...
		if(messagePromptRaised) {
			...
			if(chatMessages[k] != null) {
				...
				if(s1 != null && s1.startsWith("@cr1@")) {
					...
					s1 = s1.substring(5);
					byte0 = 3;
				} else if(s1 != null && s1.startsWith("@don@")) {
					s1 = s1.substring(5);
					byte0 = 4;
				}
				if(chatType == 0) {
					...
					if (chatTypeView == 1 || chatTypeView == 0) {
						if(yPos > 0 && yPos < 210) {
							...
							if(byte0 == 1) {
								...
								newCrowns[0].drawSprite(xPos - 2, yPos - 12);
								xPos += 14;
							}
					...
					if (chatTypeView == 2 || chatTypeView == 0) {
						if(yPos > 0 && yPos < 210) {
							...
							if(byte0 == 1) {
								...
								newCrowns[0].drawSprite(k1 - 2, yPos - 12);
								k1 += 12;
							}
					...
					if(chatTypeView == 11 || chatTypeView == 0) {
						if(yPos > 3 && yPos < 130)
							switch(chatRights[k]) {
								...
								case 4:
									j2 += clanNameWidth;
									newCrowns[0].drawSprite(j2 - 18, yPos - 12);
									j2 += 14;
									break;
...
if(myPlayer != null && myPlayer.name != null)
		...
		chatBackImage.drawGraphics(336, super.graphics, 0);
			...
			if(((Entity) (obj)).loopCycleStatus > loopCycle)
			{
				try{
					...
					if(spriteDrawX > -1)
					{
						...
						HPBarFull = new Sprite(signlink.findcachedir() + "Sprites/Player/HP 0.png", HpPercent, 7);
				...
				for(int j1 = 0; j1 < 4; j1++)
					if(((Entity) (obj)).hitsLoopCycle[j1] > loopCycle)
					{
						...
						if(spriteDrawX > -1)
						{
							...
							hitmarkDraw(e, String.valueOf(e.hitArray[j1]).length(), e.hitMarkTypes[j1], e.hitIcon[j1], e.hitArray[j1], e.soakDamage[j1], e.hitmarkMove[j1], e.hitmarkTrans[j1], j1);
						}
					}
			}
	...
	public void drawSideIcons(){
        ...
        if(tabInterfaceIDs[9] != -1)
            sideIcons[9].drawSprite(70+3, 306);
	...
	private void drawMenu() {
		...
		//DrawingArea.drawPixels(height, menuOffsetY, menuOffsetX, color, width);
		//DrawingArea.fillPixels(menuOffsetX, width, height, color, menuOffsetY);

  //Border
  DrawingArea.method338(menuOffsetY + 2, menuHeight - 4, 250, 0x706a5e, menuWidth, menuOffsetX);
  DrawingArea.method338(menuOffsetY + 1, menuHeight - 2, 250, 0x706a5e, menuWidth - 2, menuOffsetX + 1);
  DrawingArea.method338(menuOffsetY, menuHeight, 200, 0x706a5e, menuWidth - 4, menuOffsetX + 2);

  //Border
  DrawingArea.method338(menuOffsetY + 1, menuHeight - 2, 250, 0x2d2822, menuWidth - 6, menuOffsetX + 3);
  DrawingArea.method338(menuOffsetY + 2, menuHeight - 4, 250, 0x2d2822, menuWidth - 4, menuOffsetX + 2);
  DrawingArea.method338(menuOffsetY + 3, menuHeight - 6, 250, 0x2d2822, menuWidth - 2, menuOffsetX + 1);

  //Border
  DrawingArea.method338(menuOffsetY + 19, menuHeight - 22, 250, 0x524a3d, menuWidth - 4, menuOffsetX + 2);
  DrawingArea.method338(menuOffsetY + 20, menuHeight - 22, 250, 0x524a3d, menuWidth - 6, menuOffsetX + 3);
  ...
  //Menu Fill
    ...
    DrawingArea.method335(0x112329, j + 20, k - 6, l - 23, 170, i + 3);

  //Menu Header
  DrawingArea.fillPixels(menuOffsetX + 3, menuWidth - 6, 1, 0x2a291b, menuOffsetY + 2);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x2a261b, menuOffsetY + 3);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x252116, menuOffsetY + 4);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x211e15, menuOffsetY + 5);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x1e1b12, menuOffsetY + 6);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x1a170e, menuOffsetY + 7);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 2, 0x15120b, menuOffsetY + 8);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x100d08, menuOffsetY + 10);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x090a04, menuOffsetY + 11);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x080703, menuOffsetY + 12);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x090a04, menuOffsetY + 13);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x070802, menuOffsetY + 14);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x090a04, menuOffsetY + 15);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x070802, menuOffsetY + 16);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x090a04, menuOffsetY + 17);
  DrawingArea.fillPixels(menuOffsetX + 2, menuWidth - 4, 1, 0x2a291b, menuOffsetY + 18);
  DrawingArea.fillPixels(menuOffsetX + 3, menuWidth - 6, 1, 0x564943, menuOffsetY + 19);

		chatTextDrawingArea.method385(0xc6b895, "Choose Option", menuOffsetY + 14, menuOffsetX + 3);
		...
		for(int l1 = 0; l1 < menuActionRow; l1++) {
			...
			//newRegularFont.method389(true, i + 4, 0xAAA184, menuActionName[l1], i2 + 1);
			chatTextDrawingArea.method389(true, i + 4, 0xAAA184, menuActionName[l1], i2 + 1);
		}
	}
	...
	public static void main(String args[]) {
        try {
            ...
            client1.createClientFrame(501, 764);
        } catch(Exception exception) {}
    }
	...
	private void loadingStages() {
		if(lowMem && loadingStage == 2 && ObjectManager.anInt131 != plane) {
			...
			inGameScreen.drawGraphics(2, super.graphics,4);
			loadingStage = 1;
...
if (class9_4 != null && class9_4.invStackSizes[j] >= 0x186a0) {
				...
				if((j == 13 || j == 10) && inputString.length() > 0) {
					if(myPrivilege == 2 || server.equals("127.0.0.1") || 1 == 1/*to remove*/) {
						...
						if (inputString.equals("dumpitems")) {
							...
							for (int b = 0; b < ItemDef.lol.length; b++) {
								if (ItemDef.lol[b] != 0)
									fw.write(""+ItemDef.lol[b]+ ", ");	
							}
							fw.close();
		...
		for(int j = 0; j < 100; j++)
			if(chatMessages[j] != null)
			{
				...
				if((k == 3 || k == 7) && (k == 7 || privateChatMode == 0 || privateChatMode == 1 && isFriendOrSelf(s)))
				{
					...
					if(byte1 == 4)
					{
						newCrowns[0].drawSprite(k1 - 2, l - 12);
						k1 += 12;
					}
	...
	private void resetImageProducers2() {
		...
		aRSImageProducer_1114 = null;
		aRSImageProducer_1115 = null;
		chatBackImage = new RSImageProducer(516, 168, getGameComponent());
		mapBackImage = new RSImageProducer(249, 168, getGameComponent());
		DrawingArea.setAllPixelsToZero();
		newMapBack.drawSprite(0, 0);
...
//	if(cancelWalk) { return i4 > 0; }
	...
	void startUp()
	{
		...
		try {
			...
			chatArea = new Sprite("Frame/chatarea");
			...
			for(int j3 = 0; j3 <= 14; j3++)
                sideIcons[j3] = new Sprite("Gameframe/SIcons/562/icon "+j3);
	...
	private void method101(Entity entity)
	{
		...
		if(entity.anInt1517 != -1) {
			...
			if (entity.anInt1517 == myPlayer.anInt1505 || entity.anInt1517 == myPlayer.anInt1512 || entity.anInt1517 == myPlayer.anInt1555 || entity.anInt1517 == myPlayer.anInt1556 ||
				entity.anInt1517 == myPlayer.anInt1557) {
				for (int x = 0; x < animation.anIntArray355.length; x++)
					animation.anIntArray355[x] = 0; //sped up
			}
			entity.anInt1519++;
			...
			if(player.name != null && player.visible) {
				...
				if(!flag && anInt1251 == 0)
					try
					{
						...
						player.textCycle = 150;
						if(j2 == 4)
							pushMessage(s, 1, "@don@" + player.name);
						else if(j2 == 2 || j2 == 3)
	...
	private void drawMinimap() {
		int compassX = 11, compassY = 8, MapY = 9, MapX = 38;
		...
		/* Edits minimap drawing shape */
		for(int j1 = 0; j1 < anIntArray1229.length; j1++){	
			anIntArray1229[j1] = 172;
          	anIntArray1052[j1] = -22;	
		}
		/* End */
		aClass30_Sub2_Sub1_Sub1_1263.method352(152, i, anIntArray1229, 256 + minimapInt3, anIntArray1052, l2, MapY, MapX, 146, j);
		compass.method352(33, minimapInt1, anIntArray1057, 256, anIntArray968, 25, compassY, compassX - 1, 33, 25);
 ...
 //				   myPassword = "";
	...
	private void markMinimap(Sprite sprite, int i, int j) {
		...
		int l1 = j * j1 - i * i1 >> 16;
		try {
			sprite.drawSprite(((110 + k1) - sprite.anInt1444 / 2) + 4 , 89 - l1 - sprite.anInt1445 / 2 - 4);
		} catch (Exception _ex) {}
	}
				...
				case 196:
					...
					if(!flag5 && anInt1251 == 0)
						try {
							...
							if(l21 == 4)
								pushMessage(s9, 7, "@don@" + TextClass.fixName(TextClass.nameForLong(l5)));
							else if(l21 == 2 || l21 == 3)
...
smallText.method382(getMoneyOrbColor(cash), 485, ""+RSInterface.interfaceCache[8134].message+"", 102, true);
	...
	private TextDrawingArea bigHit, newFont;
...
public void drawCoinOrb(){//512 nontoggle
	...
	public void drawHP() {
		...
		if(Player.isPoisoned == 1){
			Player.poisoned.drawSprite(177, 17);
		} else {
	...
	public void drawWorldMap(){
		worldMap[1] = super.mouseX >= 522 && super.mouseX <= 558 && super.mouseY >= 124 && super.mouseY < 161;
		if (worldMap[0] && worldMap[1]) {
			WorldOrb[1].drawSprite(10, 123);
		} else if (worldMap[1]) {
			WorldOrb[1].drawSprite(10, 123);
		} else {
			WorldOrb[0].drawSprite(10, 123);
		}
	}
	...
	private void processMinimapActions() {
		...
		if(super.mouseX >= 706 && super.mouseX <= 762 && super.mouseY >= 95 && super.mouseY < 128) { 
			menuActionName[1] = !runClicked ? "Toggle Run-Mode On" : "Toggle Run-Mode On";
			menuActionID[1] = 1050;
			menuActionRow = 2;
		}
		if(super.mouseX >= 527 && super.mouseX <= 560 && super.mouseY >= 126 && super.mouseY <= 159) {
			menuActionName[1] = "Toggle World map";
			menuActionID[1] = 1005;
			menuActionRow = 2;
		}
	}
	...
	public void hitmarkDraw(Entity e, int hitLength, int type, int icon, int damage, int soak, int move, int opacity, int mask) {
		int drawPos = 0;
		if (mask == 0) {
