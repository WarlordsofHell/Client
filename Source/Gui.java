...
public class Gui extends client implements ActionListener, FocusListener {
	...
	public Gui(String args[]) {
		...
		try {
			...
			//sign.signlink.startpriv(InetAddress.getByName("thenewscapers.no-ip.info"));
			initUI();
		} catch(Exception ex)	{
			ex.printStackTrace();
		}
...
launchURL("http://TNS317.webs.com");
			}
			if (cmd.equalsIgnoreCase("Vote")) {
launchURL("http://runelocus.com/toplist/index.php?action=vote&id=20385");
				 }
...
launchURL("http://TNS317.webs.com");
			...
			if (cmd.equalsIgnoreCase("Exit")) {
				int i1;
				if((i1 = JOptionPane.showConfirmDialog(this, "Do you really want to exit the client - did you save?")) == 0)
					System.exit(0);
				return;
			}
	...
	private String frameTitle = "TheNewScapers Gameclient";
	public JFrame frame;
}